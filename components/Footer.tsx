    ...
    <footer className="bg-slate-50 border-t border-slate-200 pt-16 pb-32 md:pb-16 mt-auto">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 mb-16">
            ...
            <div className="hidden md:block w-px h-12 bg-slate-200 order-2"></div>

            {/* Social / Feedback Section */}
            <div className="flex flex-col items-center gap-3 order-1 md:order-3">
                <span className="text-slate-400 font-bold text-xs uppercase tracking-widest">Have feedback? Connect here</span>
